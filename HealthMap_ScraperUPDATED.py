...
#!/usr/bin/env python3
"""
Enhanced HealthMap Outbreak Scraper
Advanced version with better date filtering, disease analysis, and reporting
Scrapes HealthMap global disease alert system (healthmap.org)
"""
...
class ProMEDScraper:
    """Enhanced HealthMap scraper with better filtering and analysis"""
    ...
    def extract_date_from_content(self, content: str, title: str) -> Optional[datetime]:
        ...
        Looks for common date patterns in HealthMap posts
        """
        date_patterns = [
    ...
    def scrape_outbreaks(self, months_back: int = 6, max_results_per_query: int = 10) -> Dict[str, Any]:
        ...
        print(f"\n{'='*70}")
        print(f"SCRAPING HEALTHMAP OUTBREAKS")
        ...
        search_queries = [
            ...
            f"site:healthmap.org human disease outbreak {current_year}",
            f"site:healthmap.org infectious disease human {current_year}",
            f"site:healthmap.org epidemic confirmed cases {current_year}",
            
            # Animal disease queries
            f"site:healthmap.org animal disease outbreak {current_year}",
            f"site:healthmap.org livestock disease {current_year}",
            f"site:healthmap.org avian influenza {current_year}",
            f"site:healthmap.org veterinary alert {current_year}",
            
            # Zoonotic queries
            f"site:healthmap.org zoonotic disease {current_year}",
            f"site:healthmap.org zoonosis outbreak {current_year}",
            
            # General outbreak queries
            f"site:healthmap.org outbreak alert {current_year}",
            f"site:healthmap.org disease surveillance {current_year}",
            f"site:healthmap.org public health emergency {current_year}",
        ]
    ...
    def generate_report(self, categorized_data: Dict[str, Any], output_file: str = "healthmap_outbreak_report.json"):
...
def main():
    ...
    print("\n" + "="*70)
    print("ENHANCED HEALTHMAP OUTBREAK SCRAPER")
    print("="*70 + "\n")
